...
export default function WebsiteDashboard() {
  ...
  const [siteData] = useState({
    domain: "tan-partridge-419147.hostingersite.com",
      ...
      >
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
             ...
             <button className="px-5 py-2 bg-indigo-600 text-white rounded-lg text-[11px] font-bold hover:bg-indigo-700 transition-all shadow-md shadow-indigo-100 flex items-center gap-2">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 text-[11px] font-medium text-slate-500">
                  ...
                  <span className="flex items-center gap-1"><Lock size={12}/> SSL Active</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5">
              ...
              <p className="text-[10px] text-slate-400 font-medium tracking-tight">Using 650MB of 1GB total SSD storage.</p>
            </div>
          </div>

          {/* Quick Tools Grid (Right Column) */}
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
             <ToolCard icon={<FolderOpen size={18}/>} title="Files" desc="Access Root" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
           <CompactStat label="Avg. Response" value="124ms" />
           <CompactStat label="Uptime 30d" value="99.98%" />
           <CompactStat label="Visitors" value="1,204" />
           <CompactStat label="PHP Version" value="8.2" />
        </div>
...
function ToolCard({ icon, title, desc }) {
  return (
    <div className="bg-white border border-slate-200 p-4 rounded-xl hover:border-indigo-400 transition-all cursor-pointer group shadow-sm">
