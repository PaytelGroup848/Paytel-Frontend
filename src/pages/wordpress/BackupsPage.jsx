...
import { ArrowLeft, HardDrive, Database, FolderOpen, RefreshCw } from 'lucide-react';
import { useBackups } from '../../hooks/useWordPress';
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs bg-amber-50 text-amber-600 border border-amber-200 px-2 py-0.5 rounded-full">
                Last 7 days only — older backups auto-deleted
              </span>
            </div>
          </div>
        </div>
